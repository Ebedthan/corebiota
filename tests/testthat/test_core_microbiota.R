...
test_that("ASV names", {
  expect_equal(core_microbiota(df, abundance = NULL, ubiquity = 100),
...
test_that("relative sequence abundance across all samples", {
  expect_equal(round(core_microbiota(df, abundance= NULL, ubiquity = 100, stats = T)$relative_abundance, 2),
